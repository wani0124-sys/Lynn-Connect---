...
import type { SidebarMenuItem, SidebarMenuPlacement, SidebarMenuRoute } from "~/entities/sidebar-menu/model/sidebar-menu.types"
...
// 리프 메뉴(고정 5개 화면)는 그룹이 아니라서 이 함수로 삭제할 수 없다(호출 전 route === null 확인 필요).
